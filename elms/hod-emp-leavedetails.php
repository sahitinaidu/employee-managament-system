...
if(strlen($_SESSION['hod-login'])==0)
    {   
...
<html lang="en">
    <head>
        ...
        <!-- Title -->
        <title>HOD_EMP | Leave Details </title>
...
<tr>
                                          ...
                                          <td><a href="hodempleavehistory.php?empid=<?php echo htmlentities($result->id);?> && 
...
<?php 
if($stats!=1){
$email1=$_SESSION['hod-login'];?>
<?php if($email1==='registrar@nitandhra.ac.in'){
  ?>
<tr>
 <td colspan="5">
...
<div id="modal1" class="modal modal-fixed-footer" style="width:30% ; height: 40%">
   ...
   <h4>Leave take action</h4>
          ...
          <select class="browser-default" name="status" required="">
                                            ...
                                            <option value="8">Not Recommended</option>
											<option value="10">Not Eligible</option>
                                        </select>
                                        <p><textarea id="textarea1" name="description" class="materialize-textarea" name="description" placeholder="Description" length="300" maxlength="300" ></textarea></p>
  <?php  }?> 
  </div>
