...
{       $eid=$result->EmpId;
      ...
      ?>  
                                        ...
                                        <tr>
                                           ...
                                           <td><a href="updatemanager.php?mail=<?php echo htmlentities($result->EmailId);?>&&personmail=<?php echo htmlentities($res->EmailId);?>" class="waves-effect waves-light btn blue m-b-xs"  > Update </a></td>
                                    </tr>
									<?php $cnt++; } } }?>
                                    </tbody>
                                </table>
