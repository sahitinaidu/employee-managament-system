        ...
        <div class="mn-content fixed-sidebar">
            ...
            <aside id="slide-out" class="side-nav white fixed">
                ...
                <ul class="sidebar-menu collapsible collapsible-accordion" data-collapsible="accordion" style="">
                    ...
                    <li class="no-padding"><a class="waves-effect waves-grey" href="studentlogin.php">PhDStudent Login</a></li>
                    <li class="no-padding"><a class="waves-effect waves-grey" href="hod-login.php">HOD Login</a></li>
