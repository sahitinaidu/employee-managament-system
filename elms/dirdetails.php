...
<html lang="en">
    <head>
        ...
        <title>REGISTRAR | View Employee </title>
        <?php }
        else{ ?>
...
<input id="joiningdate" name="joiningdate" value="<?php echo date('j M, Y', strtotime($result->joiningdate));?>" type="text" readonly required>
</div>
<div class="input-field col m6 s12">
...
<div class="input-field col m6 s12">
<a href="dir-emp-leave-history.php?empid=<?php echo htmlentities($result->id);?> && 
                                          employeeid=<?php echo htmlentities($result->EmpId);?>
                                  " class="waves-effect waves-light btn blue m-b-xs" >View Leave History </a>
</div> 
</div>
</div>
